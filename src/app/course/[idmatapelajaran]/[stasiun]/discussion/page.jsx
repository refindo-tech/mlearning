...
import { detailDiskusi, detailMateri } from "@/backend/fetchAPI"
...
const Discussion = () => {
    ...
    useEffect(() => {
        const fetchAPI = async () => {
            try {
                const [responseDetailDiskusi, responseDetailMateri] = await Promise.all([
                    detailDiskusi({ idmapel, stasiun }),
